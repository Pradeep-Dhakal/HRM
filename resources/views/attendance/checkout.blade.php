            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" name="worklocation" class="form-control" placeholder="Work From?"
                            value="{{ $attendance->Work_location }}" />
                    </div>
                    <div class="form-group">
                    ...
                    @if (Auth::user()->hasRole('admin'))
                        <div class="form-group">
                            <label for="">checl in time: {{ $attendance->check_in }}</label>
                            <br>
                            Choose Chec in time<input type="time" name="check_in">
                        </div>
                        <div class="form-group"> <label for="">checl out time: @isset($attendance->check_out)
                                    {{ $attendance->check_in }}
                                @else
                                no checked out yet
                                @endisset
                            </label>
                            Choose Chec out time<input type="time" name="check_out">
